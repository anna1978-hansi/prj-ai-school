        ...
        <div className="min-h-screen flex items-center justify-center bg-[url('/img/login.jpg')] bg-cover bg-center">
            <div className="bg-white bg-opacity-95 p-8 sm:p-10 rounded-2xl shadow-2xl w-full max-w-md">
                ...
                <div className="flex flex-col items-center mb-6">
                    ...
                    <h2 className="text-2xl font-bold text-gray-800 mb-1">忘记密码</h2>
                    <div className="text-gray-500 text-sm">请完成身份验证以重置密码</div>
                </div>
                {/* 表单内容 */}
                <form className="space-y-5">
                    {/* 邮箱 */}
                    <div>
                        <label htmlFor="email" className="block text-gray-700 mb-1">邮箱地址</label>
                    ...
                    {/* 验证码 */}
                    <div>
                        <label htmlFor="code" className="block text-gray-700 mb-1">验证码</label>
                        <div className="flex gap-2">
                            ...
                            <button type="button" className="px-3 sm:px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 text-sm whitespace-nowrap">获取邮箱验证码</button>
                        </div>
                    </div>
                    {/* 新密码 */}
                    <div>
                        <label htmlFor="password" className="block text-gray-700 mb-1">新密码</label>
                        <div className="relative">
                            <span className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400">
                    ...
                    {/* 确认新密码 */}
                    <div>
                        <label htmlFor="confirmPassword" className="block text-gray-700 mb-1">确认新密码</label>
                        <div className="relative">
                            <span className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400">
                                <i className="fas fa-lock"></i>
                            </span>
                    ...
                    {/* 重置密码按钮 */}
                    <button type="button" className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-2.5 rounded-lg text-base transition">重置密码</button>
                </form>
                {/* 返回登录 */}
                <div className="text-center mt-6">
                    <a href="/login" className="text-blue-500 hover:underline text-sm">返回登录</a>
                </div>
            </div>
        </div>
    );
